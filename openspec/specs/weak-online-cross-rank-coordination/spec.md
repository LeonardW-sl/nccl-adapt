# weak-online-cross-rank-coordination Specification

## Purpose
Define the communicator-domain shared publication model that lets weak-online and final-steady policies be aggregated once, published once, and activated safely across local ranks.
