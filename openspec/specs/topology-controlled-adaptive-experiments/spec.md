# topology-controlled-adaptive-experiments Specification

## Purpose
TBD - created by archiving change topology-controlled-experiment-matrix. Update Purpose after archive.
## Requirements
